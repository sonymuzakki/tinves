...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Jenis details</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                    <li class="breadcrumb-item active">Jenis Details</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-group col-8">
                        <input name="jenis" class="form-control" type="text" value="{{ $jenis->jenis }}" placeholder="" id="text" disabled>
                    </div>
                </div>
