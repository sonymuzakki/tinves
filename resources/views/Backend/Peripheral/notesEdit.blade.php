...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h3 class="mb-sm-2">Notes Edit</h3><br></br><hr>
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('notes.update') }}" enctype="multipart/from-data" id="myForm">
                    @csrf
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Deskripsi</label>
                                        <input type="text" name="deskripsi"  value="{{ $notes->deskripsi }}" class="form-control" id="validationCustom01"
