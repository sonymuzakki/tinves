...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h3 class="mb-sm-2">ups Add</h3><br></br>
            <hr>
...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('store-ups') }}" enctype="multipart/from-data" id="myForm">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="merk" class="form-control" id="" placeholder="Merk"
                                        value="" required>
